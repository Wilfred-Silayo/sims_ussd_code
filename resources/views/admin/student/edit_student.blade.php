...
<div class="container justify-content-center">
    ...
    <hr>
    <form action="{{route('student.update',str_replace('/','-',$student->username))}}" id="edit-student-form"
        method="POST">
        @csrf
        @method('PUT')
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <input id="admission" type="text" disabled class="form-control @error('admission') is-invalid @enderror"
                    value="{{ old('admission',$student->admission) }}" name="admission" autocomplete="admission">
                @error('admission')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror"
                    value="{{ old('middlename',$student->middlename) }}" name="middlename" autocomplete="middlename">
                @error('middlename')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender">
                    <option value="{{old('gender',$student->gender)}}">{{$student->gender}}</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <select class="form-control @error('maritalstatus') is-invalid @enderror" id="maritalstatus"
                    name="maritalstatus">
                    <option value="{{old('maritalstatus',$student->maritalstatus)}}">{{$student->maritalstatus}}
                    </option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                    value="{{old('phone',$student->phone)}}" autocomplete="phone">
                @error('phone')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-8">
                <select class="form-control @error('program') is-invalid @enderror" id="program"
                    ...
                    <option value="{{ $program->programID }}"
                        {{ old('program', $student->program) == $program->programID ? 'selected' : '' }}>
                        {{ $program->programname }}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror" name="dob"
                    value="{{old('dob',$student->dob)}}" autocomplete="dob">
                @error('dob')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <select class="form-control @error('nationality') is-invalid @enderror" id="nationality"
                    name="nationality">
                    <option value="{{old('nationality',$student->nationality)}}">{{$student->nationality}}</option>
