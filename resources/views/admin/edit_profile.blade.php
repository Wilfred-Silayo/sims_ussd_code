    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.profile.update',str_replace('/','-',$user->username))}}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8">
                                <input id="middlename" type="text"
                                    ...
                                    value="{{ old('middlename',$user->middlename) }}" name="middlename"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8">
                                <select class="form-control @error('gender') is-invalid @enderror" id="gender"
                                    name="gender">
                                    <option value="{{old('gender',$user->gender)}}">{{$user->gender}}</option>
                        ...
                        <div class="row mb-3">
                            <label for="maritalstatus"
                                class="col col-form-labelform-label">{{__('Marital Status')}}</label>
                            <div class="col-8">
                                <select class="form-control @error('maritalstatus') is-invalid @enderror"
                                    id="maritalstatus" name="maritalstatus">
                                    <option value="{{old('maritalstatus',$user->maritalstatus)}}">
                                        {{$user->maritalstatus}}
                                    </option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8">
                                <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror"
                                    name="dob" value="{{ old('dob', $user->dob) }}" autocomplete="dob">
                                @error('dob')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8">
                                <select class="form-control @error('nationality') is-invalid @enderror" id="nationality"
                                    name="nationality">
                                    <option value="{{old('nationality',$user->nationality)}}">{{$user->nationality}}
                                    </option>
