...
<div class="container justify-content-center">
    ...
    <hr>
    <form action="{{route('lecturer.update',str_replace('/','-',$lecturer->username))}}" id="edit-lecturer-form"
        method="POST">
        @csrf
        @method('PUT')
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label for="admission" class="col col-form-labelform-label">{{__('Admission Number')}}</label>
            <div class="col-8">
                <input id="admission" type="text" class="form-control @error('admission') is-invalid @enderror"
                    value="{{ old('admission',$lecturer->admission) }}" name="admission" autocomplete="admission">
                @error('admission')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            <label for="middlename" class="col col-form-labelform-label">{{__('Middle Name')}}</label>
            <div class="col-8">
                <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror"
                    value="{{ old('middlename',$lecturer->middlename) }}" name="middlename" autocomplete="middlename">
                @error('middlename')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            <label for="gender" class="col col-form-labelform-label">{{__('Gender')}}</label>
            <div class="col-8">
                <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender">
                    <option value="{{old('gender',$lecturer->gender)}}">{{$lecturer->gender}}</option>
        ...
        <div class="row mb-3">
            <label for="maritalstatus" class="col col-form-labelform-label">{{__('Marital Status')}}</label>
            <div class="col-8">
                <select class="form-control @error('maritalstatus') is-invalid @enderror" id="maritalstatus"
                    name="maritalstatus">
                    <option value="{{old('maritalstatus',$lecturer->maritalstatus)}}">{{$lecturer->maritalstatus}}
                    </option>
            ...
            <div class="col-8">
                <select class="form-control @error('department') is-invalid @enderror" id="department"
                    ...
                    <option value="{{ $department->deptcode }}"
                        {{ old('department', $lecturer->department) == $department->deptcode ? 'selected' : '' }}>
                        {{ $department->deptname }}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3">
            <label for="phone" class="col col-form-labelform-label">{{__('Phone Number')}}</label>
            <div class="col-8">
                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                    value="{{old('phone',$lecturer->phone)}}" autocomplete="phone">
                @error('phone')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            <label for="dob" class="col col-form-labelform-label">{{__('Date of Birth')}}</label>
            <div class="col-8">
                <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror" name="dob"
                    value="{{old('dob',$lecturer->dob)}}" autocomplete="dob">
                @error('dob')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row mb-3">
            <label for="nationality" class="col col-form-labelform-label">{{__('Nationality')}}</label>
            <div class="col-8">
                <select class="form-control @error('nationality') is-invalid @enderror" id="nationality"
                    name="nationality">
                    <option value="{{old('nationality',$lecturer->nationality)}}">{{$lecturer->nationality}}</option>
