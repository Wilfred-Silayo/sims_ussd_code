...
<body>
    <div id="app" class="vh-100">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="nav-item dropdown d-flex align-items-center">
                        <img src="{{ asset('storage/'.Auth::guard('lecturer')->user()->profile_photo_path) }}"
                        ...
                        <div class="dropdown ms-2">
                            <a class="nav-link dropdown-toggle  bg-white" href="#" id="navbarDropdown" role="button"
                                ...
                                {{ Auth::guard('lecturer')->user()->firstname }}&nbsp;{{ Auth::guard('lecturer')->user()->lastname }}
                            </a>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('lecturer.logout') }}" onclick="event.preventDefault();
        ...
        @if(auth()->guard('lecturer')->check())
        <!--student dashboard-->
        @include('lecturer.lecturer_side_bar')
