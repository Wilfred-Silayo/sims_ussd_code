...
<body>
    <div id="app" class="vh-100">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="nav-item dropdown d-flex align-items-center">
                        <img src="{{ asset('storage/'.Auth::guard('web')->user()->profile_photo_path) }}"
                        ...
                        <div class="dropdown ms-2">
                            <a class="nav-link dropdown-toggle  bg-white" href="#" id="navbarDropdown" role="button"
                                ...
                                {{ Auth::guard('web')->user()->firstname }}&nbsp;{{ Auth::guard('web')->user()->lastname }}
                            </a>
        ...
        @if(auth()->guard('web')->check())
        <!--student dashboard-->
        @include('student.student_side_nav_bar')
